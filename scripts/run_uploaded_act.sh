...
case "$model" in
  ...
  rn18)
    ...
    ;;
  *)
    echo "usage: $0 {rn50_rms_5k|rn50_rms_8k|rn18|rn50_full|rn50_full_36k|ours_rn50} [--execute]" >&2
    exit 2
    ;;
esac
...
if [[ "$model" == ours_rn50 || "$model" == rn50_full || "$model" == rn50_full_36k || "$model" == rn50_rms_5k || "$model" == rn50_rms_8k ]]; then

#!/usr/bin/env bash
# End-to-end fine-tune TCC ours_vit with official ACT on the curated 40 demos.
...
run_name="act_ours_vit_carrot_to_pot_40_color3_e2e_lr1e7_train40_${steps}steps"
...
# Keep data ordering and photometric augmentation identical to the frozen ViT run.
...
/usr/bin/time -f "WALL=%e RSS_KB=%M" .venv/bin/lerobot-train \
  ...
  --policy.repo_id=Chipaipai/act-ours-vit-carrot-to-pot-40-color3-e2e-lr1e7-8k \

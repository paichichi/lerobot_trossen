#!/usr/bin/env bash
# Train official LeRobot ACT with an ImageNet ResNet-50 on all 40 oblique-view demos.
...
run_name="act_official_rn50_carrot_to_pot_40_train40_${steps}steps"
...
/usr/bin/time -f "WALL=%e RSS_KB=%M" .venv/bin/lerobot-train \
  ...
  --policy.type=act \
  --policy.repo_id=Chipaipai/act-official-rn50-carrot-to-pot-40-train40-8k \
